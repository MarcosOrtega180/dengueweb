    ...
    Highcharts.chart('burbujas', {
        ...
        tooltip: {
            ...
            pointFormat: '<tr><th colspan="2"><h3>{point.country}</h3></th></tr>' +
                '<tr><th>Código de departamento:</th><td>{point.x}</td></tr>' +
                '<tr><th>Densidad poblacional (hab/km<sup>2</sup>):</th><td>{point.y}</td></tr>' +
        ...
        series: [{
            'data': [{'x': 0, 'y': 4525.07, 'z': 5028, 'name': '0-AS', 'country': 'ASUNCION'},
                {'x': 1, 'y': 12.55, 'z': 1233, 'name': '1-CN', 'country': 'CONCEPCION'},
                {'x': 2, 'y': 19.71, 'z': 140, 'name': '2-SP', 'country': 'SAN PEDRO'},
                {'x': 3, 'y': 56.56, 'z': 305, 'name': '3-CR', 'country': 'CORDILLERA'},
                {'x': 4, 'y': 54.58, 'z': 48, 'name': '4-GU', 'country': 'GUAIRA'},
                {'x': 5, 'y': 45.16, 'z': 142, 'name': '5-CG', 'country': 'CAAGUAZU'},
                {'x': 6, 'y': 18.15, 'z': 4, 'name': '6-CZ', 'country': 'CAAZAPA'},
                {'x': 7, 'y': 33.56, 'z': 43, 'name': '7-IT', 'country': 'ITAPUA'},
                {'x': 8, 'y': 12.21, 'z': 25, 'name': '8-MI', 'country': 'MISIONES'},
                {'x': 9, 'y': 28.54, 'z': 231, 'name': '9-PG', 'country': 'PARAGUARI'},
                {'x': 10, 'y': 49.49, 'z': 10, 'name': '10-AA', 'country': 'ALTO PARANA'},
                {'x': 11, 'y': 752.63, 'z': 17430, 'name': '11-CE', 'country': 'CENTRAL'},
                {'x': 12, 'y': 7.09, 'z': 13, 'name': '12-NE', 'country': 'ÑEEMBUCU'},
                {'x': 13, 'y': 11.71, 'z': 603, 'name': '13-AM', 'country': 'AMAMBAY'},
                {'x': 14, 'y': 13.56, 'z': 61, 'name': '14-CY', 'country': 'CANINDEYU'},
                {'x': 15, 'y': 1.51, 'z': 171, 'name': '15-PH', 'country': 'PRESIDENTE HAYES'},
                {'x': 16, 'y': 0.62, 'z': 7, 'name': '16-BQ', 'country': 'BOQUERÓN'},
                {'x': 17, 'y': 0.19, 'z': 7, 'name': '17-AG', 'country': 'ALTO PARAGUAY'}]
        },
            {
                'data': [{'x': 0, 'y': 4517.33, 'z': 20578, 'name': '0-AS', 'country': 'ASUNCION'},
                    {'x': 1, 'y': 12.74, 'z': 804, 'name': '1-CN', 'country': 'CONCEPCION'},
                    {'x': 2, 'y': 19.96, 'z': 290, 'name': '2-SP', 'country': 'SAN PEDRO'},
                    {'x': 3, 'y': 57.32, 'z': 1163, 'name': '3-CR', 'country': 'CORDILLERA'},
                    {'x': 4, 'y': 55.12, 'z': 859, 'name': '4-GU', 'country': 'GUAIRA'},
                    {'x': 5, 'y': 45.63, 'z': 2057, 'name': '5-CG', 'country': 'CAAGUAZU'},
                    {'x': 6, 'y': 18.4, 'z': 62, 'name': '6-CZ', 'country': 'CAAZAPA'},
                    {'x': 7, 'y': 34.0, 'z': 293, 'name': '7-IT', 'country': 'ITAPUA'},
                    {'x': 8, 'y': 12.34, 'z': 155, 'name': '8-MI', 'country': 'MISIONES'},
                    {'x': 9, 'y': 28.68, 'z': 1198, 'name': '9-PG', 'country': 'PARAGUARI'},
                    {'x': 10, 'y': 50.31, 'z': 263, 'name': '10-AA', 'country': 'ALTO PARANA'},
                    {'x': 11, 'y': 770.22, 'z': 90163, 'name': '11-CE', 'country': 'CENTRAL'},
                    {'x': 12, 'y': 7.14, 'z': 102, 'name': '12-NE', 'country': 'ÑEEMBUCU'},
                    {'x': 13, 'y': 11.91, 'z': 2774, 'name': '13-AM', 'country': 'AMAMBAY'},
                    {'x': 14, 'y': 13.88, 'z': 777, 'name': '14-CY', 'country': 'CANINDEYU'},
                    {'x': 15, 'y': 1.54, 'z': 1947, 'name': '15-PH', 'country': 'PRESIDENTE HAYES'},
                    {'x': 16, 'y': 0.63, 'z': 64, 'name': '16-BQ', 'country': 'BOQUERÓN'},
                    {'x': 17, 'y': 0.19, 'z': 58, 'name': '17-AG', 'country': 'ALTO PARAGUAY'}]
            }]
