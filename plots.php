...
echo "<script  type='text/javascript' >console.log(".$arr[2].")</script>";
echo "<script  type='text/javascript' >let val = '".$hi."';</script>";

?>

<script type="text/javascript">

    console.log('funcionaaaaaaaaaaaaaaaaaa', val);
    let hello = <?php echo $arr[2] ?>
